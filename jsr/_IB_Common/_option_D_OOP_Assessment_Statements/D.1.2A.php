...
<h1>OOP &quot;Template&quot; Class - Part 2</h1>
<h2>Classes</h2>
...
<h2>Classes Are Made Up of Attributes and Methods</h2>
<p>Everything in a class is either a data type, which we'll call an attribute, or a method which somehow uses or manipulates one or more of the attributes. Usually we list the attributes with global scope at the top of the program, and then the rest of the program is the various methods that work with these attributes.</p>
<p>The first page of notes about &quot;template&quot; classes had one major omission regarding good Object Oriented Programming (OOP) design; it left the attributes without the word &quot;private&quot; in their declaration. This should never actually done - in our case it was done simply to keep the instruction as simple as possible for the first notes. But with these notes, we can take a look at what is necessary when you properly make your attributes private: &quot;get&quot; and &quot;set&quot; methods.</p>
<h2>The Reason For Private Attributes</h2>
...
<h2>The Four General Kinds of Methods in a Template Class</h2>
...
<p><strong>The <em>Implementation</em> of the Constructors of the EndangeredSpecies Class</strong>:</p>
<pre>
...
<p>When constructors are called by other classes making instances of a certain class, the new operator is used to find a free block of memory apporpriately sized for that class. In the case of the example here, that would be enough memory for one String, one int, and one boolean. (This was shown in the last notes, too.) Here is a line using the above first &quot;overloaded&quot; constructor:</p>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
<html>
<head>
<title>NewClass.java</title>
...
<strong><em>Calling</em> One of the Constructors of the EndangeredSpecies Class</strong>
<pre>
<span class="line-number"></span>    
...
<h2>A Class That Uses Our Template Class</h2>
<p>Here is the code for a GUI that uses the above template class. For these notes, it's not necessary to understand all of it, but it is included here for a sense of completion. Primarily look for where instances of the EndangeredSpecies class is made, and where the various methods are called.</p>
...
<span class="line-number"> 19</span> 
<span class="line-number"> 20</span>     <span class="keyword-directive">private</span> EndangeredSpecies[] speciesArray = <span class="keyword-directive">new</span> EndangeredSpecies[10];
...
<span class="line-number"> 30</span>             speciesArray[i] = <span class="keyword-directive">new</span> EndangeredSpecies();
...
<span class="line-number">288</span>         speciesArray[arrayCount].setSpeciesName(jTextFieldNameEntered.getText());
<span class="line-number">289</span>         speciesArray[arrayCount].setNumberLeft(Integer.parseInt(jTextFieldPopulationEntered.getText()));
<span class="line-number">290</span>         arrayCount++;
<span class="line-number">291</span>         System.out.println(speciesArray[0].getSpeciesName());
...
<span class="line-number">297</span>             jComboBoxForNames.addItem(speciesArray[i].getSpeciesName());
...
<span class="line-number">305</span>             <span class="keyword-directive">if</span>(speciesArray[i].getSpeciesName().equals(selectedSpecies)){
<span class="line-number">306</span>                 speciesArray[i].adjustNumberLeft(Integer.parseInt(jTextFieldAdditionalKilled.getText()));
<span class="line-number">307</span>                 <span class="keyword-directive">if</span>(speciesArray[i].getCritical()){
...
<img src="../Java-Revolution/_Images/EndangeredSpecies-1.jpg" width="447" height="387">
